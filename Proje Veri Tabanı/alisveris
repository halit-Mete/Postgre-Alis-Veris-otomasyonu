...
-- Started on 2022-12-28 08:57:04
...
--
-- TOC entry 236 (class 1259 OID 16915)
...
--
-- TOC entry 231 (class 1259 OID 16883)
...
--
-- TOC entry 238 (class 1259 OID 16962)
...
CREATE VIEW public.teslimatnoktasi AS
 SELECT teslimatadres.teslimatno,
    ...
    ilce.acikadres
   FROM ((public.il
     JOIN public.teslimatadres ON ((il.il_plakano = teslimatadres.ilno)))
...
1	800	25.10.2022	1
3	800	20.10.2022	3
4	10000	20.06.2022	4
5	13000	10.04.2022	5
\.
...
2	Kasran	Çayran Mah...	34
5	Çayırlık	Kenar Mah...	1
\.
...
-- Completed on 2022-12-28 08:57:04
